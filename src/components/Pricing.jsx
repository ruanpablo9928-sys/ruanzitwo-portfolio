    ...
    return (
        <section className="py-20 bg-brand-dark text-white relative overflow-hidden" id="pricing">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <RevealOnScroll>
                    <div className="max-w-3xl mx-auto bg-gradient-to-br from-white/10 to-white/5 rounded-3xl p-1 border border-white/20 shadow-2xl overflow-hidden hover:border-brand-accent/30 transition-colors duration-500">
                        <div className="bg-black/40 backdrop-blur-xl rounded-[22px] p-8 md:p-12 text-center relative group">
                            ...
                            <div className="flex items-center justify-center gap-2 mb-8">
                                ...
                                <span className="text-6xl font-bold text-white">R$ 70<span className="text-3xl">,00</span></span>
                            </div>

                            <div className="grid md:grid-cols-2 gap-4 text-left max-w-lg mx-auto mb-10">
                                <div className="flex items-center gap-3">
                                    <div className="p-1 bg-green-500/20 rounded-full text-green-400 flex-shrink-0"><Check size={16} /></div>
                                    <span className="text-gray-300">Vídeos de até 2 minutos</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="p-1 bg-green-500/20 rounded-full text-green-400 flex-shrink-0"><Check size={16} /></div>
                                    <span className="text-gray-300">Correção de Cor (Color Grading)</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="p-1 bg-green-500/20 rounded-full text-green-400 flex-shrink-0"><Check size={16} /></div>
