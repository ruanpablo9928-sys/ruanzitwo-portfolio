                ...
                <RevealOnScroll delay={0.2}>
                    <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
                        <a href="https://wa.me/5588996126717" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-xl hover:text-brand-accent transition-colors group">
                            <div className="p-4 bg-white/5 rounded-full group-hover:bg-brand-accent/20 transition-colors border border-white/5">
                                <Phone className="w-6 h-6" />
                            </div>
                            <span className="font-medium tracking-wide">(88) 99612-6717</span>
                        </a>
                        ...
                        <a href="https://instagram.com/ru4neditsz" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-xl hover:text-pink-500 transition-colors group">
                            <div className="p-4 bg-white/5 rounded-full group-hover:bg-pink-500/20 transition-colors border border-white/5">
                                <Instagram className="w-6 h-6" />
                            </div>
                            <span className="font-medium tracking-wide">@ru4neditsz</span>
                        </a>
                        ...
                        <a href="https://tiktok.com/@ruanzitwo" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-xl hover:text-cyan-400 transition-colors group">
                            <div className="p-4 bg-white/5 rounded-full group-hover:bg-cyan-400/20 transition-colors border border-white/5">
                            ...
                            <span className="font-medium tracking-wide">ruanzitwo</span>
                        </a>
                    </div>
                </RevealOnScroll>
            </div>
